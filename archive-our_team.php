...
<div class="container">
	<h1>Our Team</h1>
<?php
	$case_studies = new WP_Query(array( 'post_type' => 'our_team', 'posts_per_page' => -1, 'order'   => 'ASC', ) );
	while ( $case_studies->have_posts() ) : $case_studies->the_post(); $count++; 
		...
		<?php
			if ( has_post_thumbnail() ) {
				the_post_thumbnail('team-thumbnail', array('class' => 'alignleft img-responsive'));
			} else {
				echo '<img width="300" height="300" src="' . get_bloginfo( 'stylesheet_directory' ) . '/images/team-thumbnail.jpg" class="aligncenter wp-post-image img-responsive" alt="Zen Agency Placeholder" />';
			}
		?>
				</div>
